      ...
      * DATA......: 01/07/2026
      * OBJETIVO..: LER O PROGRAMA BHCP0013 E GERAR LOL
      ...
      ******************************************************************
       ...
       200000-ABRIR-ARQUIVOS.
           ...
           IF WS-FS-BHCF013L NOT = WS-FS-OK
               DISPLAY 'ERRO OPEN OUTPUT BHCF013L FS='
                       WS-FS-BHCF013L
               ADD 1 TO GDA-TOT-ERROS
               SET GDA-FIM-SIM TO TRUE
           END-IF.
       ...
       500000-GRAVAR-LOG.
           ...
           IF WS-FS-BHCF013L NOT = WS-FS-OK
               ...
               DISPLAY 'ERRO WRITE BHCF013L FS='
                       WS-FS-BHCF013L
