      ...
      * DATA......: 01/07/2026
      * OBJETIVO..: LER O PROGRAMA BHCP0014 E GERAR LOG DE REJEICOES
      ...
      ******************************************************************
       ...
       200000-ABRIR-ARQUIVOS.
           ...
           IF WS-FS-BHCF014L NOT = WS-FS-OK
               DISPLAY 'ERRO OPEN OUTPUT BHCF014L FS='
                       WS-FS-BHCF014L
               ADD 1 TO GDA-TOT-ERROS
               SET GDA-FIM-SIM TO TRUE
           END-IF.
       ...
       510000-GRAVAR-VALIDO.
           ...
           ELSE
               DISPLAY 'ERRO WRITE BHCF014S FS='
                       WS-FS-BHCF014S
               ADD 1 TO GDA-TOT-ERROS
           END-IF.
       ...
       520000-GRAVAR-LOG.
           ...
           ELSE
               DISPLAY 'ERRO WRITE BHCF014L FS='
                       WS-FS-BHCF014L
               ADD 1 TO GDA-TOT-ERROS
           END-IF.
