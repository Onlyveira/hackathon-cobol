      ...
      * DATA......: 01/07/2026
      * OBJETIVO..: GERAR O PROGRAMA BHCF012S
      * EXECUCAO..: COBOL - BATCH
      * ----------------------------------------------------------------
      * VRS DATA     RESPONSAVEL     DESCRICAO DA VERSAO
      * --- -------- --------------- ----------------------------------
      * 001 01.07.26 LEANDRO DAVI       IMPLANTACAO
      * ----------------------------------------------------------------
      ******************************************************************
      ...
      ******************************************************************
       ...
       01 GDA-CONTROLES.
          05 GDA-INDICE               PIC 9(02) VALUE ZERO.
      ...
      ******************************************************************
       ...
       01 GDA-TOTALIZADORES.
          05 GDA-TOT-GRAVADOS         PIC 9(05) VALUE ZERO.
          05 GDA-TOT-ERROS            PIC 9(05) VALUE ZERO.
      ...
      ******************************************************************
       ...
       01 GDA-TABELA-PARTICIPANTES.
          ...
          05 GDA-PARTICIPANTE OCCURS 10 TIMES.
             ...
             10 GDA-CODIGO            PIC 9(05).
             10 GDA-NOME              PIC X(30).
             10 GDA-UF                PIC X(02).
             10 GDA-TRILHA            PIC X(10).
             10 GDA-SITUACAO          PIC X(10).
             10 GDA-DATA              PIC 9(08).
      ...
      *     DISPLAY "FS APOS OPEN = " FS-BHCF012S. - TESTE
      ...
      *     DISPLAY "ENTROU NO 400000". - TESTE
           IF GDA-TOT-ERROS = ZERO

              PERFORM VARYING GDA-INDICE FROM 1 BY 1
                  UNTIL GDA-INDICE > 10

                  MOVE GDA-CODIGO(GDA-INDICE)
                    TO FD-CODIGO

                  MOVE GDA-NOME(GDA-INDICE)
                    TO FD-NOME

                  MOVE GDA-UF(GDA-INDICE)
                    TO FD-UF

                  MOVE GDA-TRILHA(GDA-INDICE)
                    TO FD-TRILHA

                  MOVE GDA-SITUACAO(GDA-INDICE)
                    TO FD-SITUACAO

                  MOVE GDA-DATA(GDA-INDICE)
                    TO FD-DATA
      *     DISPLAY "INDICE = " GDA-INDICE - TESTE
                  WRITE REG-BHCF012S
      *            DISPLAY "FS WRITE = " FS-BHCF012S - TESTE

                  IF FS-BHCF012S = '00'
                     ADD 1 TO GDA-TOT-GRAVADOS
                  ELSE
                     DISPLAY 'ERRO NA GRAVACAO. FILE STATUS: '
                             FS-BHCF012S
                     ADD 1 TO GDA-TOT-ERROS
                  END-IF
       ...
       900000-FECHAR-ARQUIVO.
           ...
           IF FS-BHCF012S = '00'
               DISPLAY 'ARQUIVO BHCF012S FECHADO COM SUCESSO'
           ELSE
               DISPLAY 'ERRO AO FECHAR BHCF012S. FILE STATUS: '
                       FS-BHCF012S
           END-IF
